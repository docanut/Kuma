...
public class Ships {
	...
	public String inbattle,inbath,ingame;
	public static Ships ships[]=new Ships[5];
	public static void initialize(){
		for (int i = 0; i < ships.length; i++) {
			ships[i]=new Ships();
			ships[i].inbattle ="quest0"+(i+1)+"g";
			ships[i].ingame="quest0"+(i+1)+"o";
			ships[i].inbath ="quest0"+(i+1)+"b";
			System.out.println();
		}
	}
